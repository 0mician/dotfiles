...
TOOLS=/home/sid/Tools
export PATH=/usr/local/bin:/usr/local/sbin:$TOOLS/Zotero_linux-x86_64:/usr/local/go/bin:$PATH
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/sid/Downloads/yes/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/home/sid/Downloads/yes/etc/profile.d/conda.sh" ]; then
        . "/home/sid/Downloads/yes/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/home/sid/Downloads/yes/bin:$PATH"
    fi
fi
unset __conda_setup
